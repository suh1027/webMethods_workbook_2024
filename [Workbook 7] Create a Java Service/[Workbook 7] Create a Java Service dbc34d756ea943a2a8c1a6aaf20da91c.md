...
#### STEP 1. 최상위 폴더 아래 IF0006와 IF0006.svc 폴더를 생성하고, 그 안에 svc_IF0006_endsWith라는 새 Java Service를 생성하세요. 이 서비스에는 string 및 suffix 두 개의 String 타입의 Input 및 value 라는 String 타입의 Output이 있어야 합니다.       
